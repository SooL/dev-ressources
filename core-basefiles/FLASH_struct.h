	...
	namespace core
	{
		class FLASH
		{
			...
			struct CRCDATA_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_CRCDATA-DECLARATION
			};
			#endif
			...
			struct CRCEADDR_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_CRCEADDR-DECLARATION
			};
			#endif
			...
			struct CRCSADDR_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_CRCSADDR-DECLARATION
			};
			#endif
			...
			struct OPTKEYR_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_OPTKEYR-DECLARATION
			};
			#endif
			...
			struct PCROP1ER_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_PCROP1ER-DECLARATION
			};
			#endif
			...
			struct PCROP1SR_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_PCROP1SR-DECLARATION
			};
			#endif
			...
			struct PCROP2ER_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_PCROP2ER-DECLARATION
			};
			#endif
			...
			struct PCROP2SR_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_PCROP2SR-DECLARATION
			};
			#endif
			...
			struct PRGKEYR_TypeDef : public Reg32_t
			{
				...
				//SOOL-FLASH_PRGKEYR-DECLARATION
			};
			#endif
