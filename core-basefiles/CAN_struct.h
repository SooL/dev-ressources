	...
	namespace core
	{
		class CAN
		{
			...
			struct BTR_TypeDef : public Reg32_t
			{
				...
				//SOOL-CAN_BTR-DECLARATION
			};
			#endif
			
			class CAN_FIFOMailBox
			{
				//SOOL-CAN_FIFOMailBox-ENUMS
				...
				struct RDHR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_FIFOMailBox_RDHR-DECLARATION
				};
				#endif
				...
				struct RDLR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_FIFOMailBox_RDLR-DECLARATION
				};
				#endif
				...
				struct RDTR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_FIFOMailBox_RDTR-DECLARATION
				};
				#endif
				...
				struct RIR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_FIFOMailBox_RIR-DECLARATION
				};
				#endif
				...
				//SOOL-CAN_FIFOMailBox-DECLARATION
			};
			
			
			class CAN_FilterRegister
			{
				//SOOL-CAN_FilterRegister-ENUMS
				...
				struct FR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_FilterRegister_FR-DECLARATION
				};
				#endif
				...
				//SOOL-CAN_FilterRegister-DECLARATION
			};
			
			
			class CAN_TxMailBox
			{
				//SOOL-CAN_TxMailBox-ENUMS
				...
				struct TDHR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_TxMailBox_TDHR-DECLARATION
				};
				#endif
				...
				struct TDLR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_TxMailBox_TDLR-DECLARATION
				};
				#endif
				...
				struct TDTR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_TxMailBox_TDTR-DECLARATION
				};
				#endif
				...
				struct TIR_TypeDef : public Reg32_t
				{
					...
					//SOOL-CAN_CAN_TxMailBox_TIR-DECLARATION
				};
				#endif
				...
				//SOOL-CAN_TxMailBox-DECLARATION
			};
