...
if __name__ == "__main__" :
	...
	(file_struct, file_def, dest_file) = build_files_names(args.source_file, args.dest_dir)
	dest_dir = Path(args.dest_dir)

	try :
		perform_checks(file_struct, file_def, dest_dir)
	except FileNotFoundError :
		if "_struct" in args.source_file :
			shutil.copy(args.source_file,dest_file)
			print("\tInput definition file not found. Copying the struct file 'as is'")
	else :
