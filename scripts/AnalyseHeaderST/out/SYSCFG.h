...
#define SYSCFG_CFGR1_0_USART3_DMA_RMP
    ...
    defined(STM32F078xx ) || defined(STM32F3     ) || defined(STM32L4     ) || defined(STM32L4P    ) 
...
#define SYSCFG_CFGR1_1_USART1RX_DMA_RMP
    ...
    defined(STM32F042x6 ) || defined(STM32F048xx ) || defined(STM32F051x8 ) || defined(STM32F058xx ) ||\
    defined(STM32F070x6 ) || defined(STM32F070xB ) || defined(STM32F071xB ) || defined(STM32F072xB ) ||\
    defined(STM32F078xx ) || defined(STM32F3     ) 
	...
	namespace core
	{
		class SYSCFG
		{
			...
			struct EXTICR_TypeDef : public BigArrayReg_t<uint32_t, 0, 4, 4>
			{
				...
				//SOOL-SYSCFG_EXTICR-DECLARATION
			};
			#endif
			...
			struct IT_LINE_SR_TypeDef : public BigArrayReg_t<uint32_t, 0, 4, 32>
			{
				...
				//SOOL-SYSCFG_IT_LINE_SR-DECLARATION
			};
			#endif
			...
			struct MCHDLYCR_TypeDef : public Reg32_t
			{
				...
				//SOOL-SYSCFG_MCHDLYCR-DECLARATION
			};
			#endif
			...
			struct MEMRMP_TypeDef : public Reg32_t
			{
				...
				//SOOL-SYSCFG_MEMRMP-DECLARATION
			};
			#endif
