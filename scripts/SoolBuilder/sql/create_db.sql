...
CREATE TABLE IF NOT EXISTS peripherals (
	id INTEGER PRIMARY KEY AUTOINCREMENT,
	name TEXT UNIQUE NOT NUll,
	grp TEXT NOT NULL REFERENCES groups(name) ON DELETE RESTRICT ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS instances (
	id INTEGER PRIMARY KEY AUTOINCREMENT,
	periph_id INTEGER NOT NULL REFERENCES peripheral(id) ON DELETE CASCADE ON UPDATE CASCADE,
	name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS reg_placements (
	...
	UNIQUE (inst_id,register_id) ON CONFLICT FAIL
);
...
CREATE TABLE IF NOT EXISTS registers (
	...
	size INT DEFAULT 32,
	type TEXT,
	sub_periph_id INTEGER REFERENCES peripherals(id) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS field_placements (
	...
	UNIQUE (field_id,reg_placement_id) ON CONFLICT IGNORE
);
